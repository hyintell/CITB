...
results_folder_dir="output/continual_instruction_tuning/stream=cl_dialogue_long_tasks/CL=L2"
save_metrics_folder="scores/continual_instruction_tuning/stream=cl_dialogue_long_tasks/CL=L2"
