...
results_folder_dir="output/continual_instruction_tuning/stream=cl_dialogue_tasks/CL=AGEM"
save_metrics_folder="scores/continual_instruction_tuning/stream=cl_dialogue_tasks/CL=AGEM"
