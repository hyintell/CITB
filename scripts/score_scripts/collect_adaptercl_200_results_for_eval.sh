...
results_folder_dir="output/continual_instruction_tuning/stream=cl_dialogue_tasks/CL=ADAPTERCL_bsize200"
save_metrics_folder="scores/continual_instruction_tuning/stream=cl_dialogue_tasks/CL=ADAPTERCL_bsize200"
