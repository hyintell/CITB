...
do 
    ...
    output_dir="output/ablation_continual_instruction_tuning/stream=${stream_name}/CL=${cl_method}_instancesize=${max_num_instances_per_task}/order${order}_seed${seed}"
