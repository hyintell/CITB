...
do 
    ...
    output_dir="output/ablation_continual_instruction_tuning/stream=${stream_name}/CL=${cl_method}_LM_n=${add_task_name}_d=${add_task_definition}_p${num_pos_examples}_n${num_neg_examples}_e=${add_explanation}/order${order}_seed${seed}"
