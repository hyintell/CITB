...
do 
    ...
    output_dir="output/ablation_continual_instruction_tuning/stream=${task_split_file_name}/CL=${cl_method}_LM_instancesize=${max_num_instances_per_task}/order${order}_seed${seed}"
