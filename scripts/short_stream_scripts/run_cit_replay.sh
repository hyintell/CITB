...
# cl_method="FT_seq"
cl_method="REPLAY"
replay_num_instance_per_task=50
...
do 
    ...
    output_dir="output/continual_instruction_tuning/stream=${task_split_file_name}/CL=${cl_method}/replay_num${replay_num_instance_per_task}_epoch${num_train_epochs}_bs${per_device_train_batch_size}_lr${learning_rate}_order${order}_seed${seed}"
