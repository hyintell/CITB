...
do 
    ...
    output_dir="output/continual_instruction_tuning/stream=${task_split_file_name}/CL=${cl_method}_LM/epoch${num_train_epochs}_bs${per_device_train_batch_size}_lr${learning_rate}_order${order}_seed${seed}"
