...
do 
    ...
    output_dir="output/continual_instruction_tuning/stream=${stream_name}/CL=${cl_method}_replay_num${replay_num_instance_per_task}/reg${reg}_epoch${num_train_epochs}_bs${per_device_train_batch_size}_lr${learning_rate}_order${order}_seed${seed}"
